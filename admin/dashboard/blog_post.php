...
// Modify SQL query to select blog posts based on logged-in username
if ($username == 'master') {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>" . $row["username"] . "</td>
                        <td>
                            <a href='blog_edit.php?id_blog=" . $row['id_blog'] . "' class='btn btn-primary btn-sm'>Edit</a>
                            <a href='delete_blog.php?id_blog=" . $row['id_blog'] . "' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                      </tr>";
            }
        } else {
