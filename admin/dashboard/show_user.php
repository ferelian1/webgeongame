    ...
    <div class="row">
            ...
            <div class="col-9">
                <div class="container mt-5">
                    <h2>User Posts</h2>
                    <table id="userTable" class="table table-success table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Username</th>
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='delete_user.php?id_user=" . $row['id_user'] . "' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                     </tr>";
            }
        } else {
