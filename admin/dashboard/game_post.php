...
$sql = "SELECT id_game, game_name FROM game";
    ...
    <div class="row">
            ...
            <div class="col-9">
                <div class="container mt-5">
                    <h2>Game Posts</h2>
                    <table id="gameTable" class="table table-success table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Game Name</th>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>" . $row["game_name"] . "</td>
                        <td>
                            <a href='game_edit.php?id_game=" . $row['id_game'] . "' class='btn btn-primary btn-sm'>Edit</a>
                            <a href='delete_game.php?id_game=" . $row['id_game'] . "' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                     </tr>";
            }
        } else {
